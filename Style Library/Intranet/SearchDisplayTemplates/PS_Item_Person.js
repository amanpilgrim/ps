...
function DisplayTemplate_1f2cb88467a34a3395de2b9a1b36fff2(ctx) {

    var ms_outHtml = [];
    var cachePreviousTemplateData = ctx['DisplayTemplateData'];
    ctx['DisplayTemplateData'] = new Object();
    DisplayTemplate_1f2cb88467a34a3395de2b9a1b36fff2.DisplayTemplateData = ctx['DisplayTemplateData'];
    ...
    if (!$isNull(ctx.CurrentItem) && !$isNull(ctx.ClientControl)) {
        ...
        ms_outHtml.push('	'
        , '                                <div id="NameValue" class="ms-srch-item-summary">'
        , '                                    <a clicktype="Result" class="ms-srch-ellipsis" id="NameFieldLink" href="', encodedPath, '" title="', displayName, '">', displayName, '</a>'
        , '                                </div>'
        , '                            </div>'
        );
        ...
        if (has_bu == true) {
            ...
            ms_outHtml.push(''
            , '                            <div id="BusinessUnitField" class="ms-srch-item-summary">'
        ...
        if (has_psorganisation == true) {
            ...
            , '                                <div id="OrganisationValue" class="ms-srch-ellipsis" title="', organisation, '">Organisation: ', organisation, ' </div>'
            , '                            </div>'
            );
        }
        ms_outHtml.push(''
        ...
        if (has_phno == true) {
            ...
            , ''
            , '                            <div id="PhoneField">'
            , '                                <div id="PhoneValue" class="ms-srch-ellipsis" title="', phone, '">Preferred phone: <a href="tel:', phone, '">', phone, '</a></div>'
            , '                            </div>'
            );
        }
        ...
        if (has_mob == true) {
            ...
            , ''
            , '                            <div id="MobileField">'
            , '                                <div id="MobileValue" class="ms-srch-ellipsis" title="', encodedMobilePhone, '">Mobile: <a href="tel:', encodedMobilePhone, '">', encodedMobilePhone, '</a></div>'
            , '                            </div>'
            );
        }
...
function RegisterTemplate_1f2cb88467a34a3395de2b9a1b36fff2() {

    if ("undefined" != typeof (Srch) && "undefined" != typeof (Srch.U) && typeof (Srch.U.registerRenderTemplateByName) == "function") {
        Srch.U.registerRenderTemplateByName("Item_Person", DisplayTemplate_1f2cb88467a34a3395de2b9a1b36fff2);
    }

    if ("undefined" != typeof (Srch) && "undefined" != typeof (Srch.U) && typeof (Srch.U.registerRenderTemplateByName) == "function") {
        Srch.U.registerRenderTemplateByName("~sitecollection\u002f_catalogs\u002fmasterpage\u002fDisplay Templates\u002fSearch\u002fPS_Item_Person.js", DisplayTemplate_1f2cb88467a34a3395de2b9a1b36fff2);
    }

}
RegisterTemplate_1f2cb88467a34a3395de2b9a1b36fff2();
if (typeof (RegisterModuleInit) == "function" && typeof (Srch.U.replaceUrlTokens) == "function") {
    RegisterModuleInit(Srch.U.replaceUrlTokens("~sitecollection\u002f_catalogs\u002fmasterpage\u002fDisplay Templates\u002fSearch\u002fPS_Item_Person.js"), RegisterTemplate_1f2cb88467a34a3395de2b9a1b36fff2);
}
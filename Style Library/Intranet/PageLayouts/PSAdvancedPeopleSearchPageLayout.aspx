...
<%@ Register TagPrefix="PS" TagName="AdvancedPeopleSearch" Src="~/_controltemplates/15/PeopleSearch/AdvancedPeopleSearch.ascx" %>
...
<asp:Content ContentPlaceHolderId="PlaceHolderMain" runat="server">
	...
	<div id="top" class="primary">
		...
		<article>			
			<div>	
                <PS:AdvancedPeopleSearch runat="server" id="AdvancedPeopleSearch" />
            </div>

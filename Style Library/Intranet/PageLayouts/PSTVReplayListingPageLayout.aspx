...
<asp:Content contentplaceholderid="PlaceHolderAdditionalPageHead" runat="server">
	...
	<SharePointWebControls:CssRegistration ID="CssRegistration4" name="<% $SPUrl:~sitecollection/Style Library/~language/Themable/Core Styles/pagelayouts15.css %>" runat="server"/>
	...
	<div id="top" class="primary">
		<article>
            ...
            <PublishingWebControls:EditModePanel ID="EditModePanel2" runat="server" CssClass="edit-mode-panel" PageDisplayMode="Display">
		        <PS:TVReplayList id="sectionList" runat="server"/>
            </PublishingWebControls:EditModePanel>

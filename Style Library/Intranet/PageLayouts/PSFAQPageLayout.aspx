...
<%@ Register TagPrefix="PS" TagName="FaqContent" Src="~/_controltemplates/15/FAQs/FaqContent.ascx" %>
<%@ Register TagPrefix="PS" TagName="FaqTopics" Src="~/_controltemplates/15/FAQs/FaqTopics.ascx" %>
<%@ Register TagPrefix="PS" TagName="FaqSuggestQuestion" Src="~/_controltemplates/15/FAQs/FaqSuggestQuestion.ascx" %>
...
<asp:Content ContentPlaceHolderId="PlaceHolderMain" runat="server">
    ...
    <PublishingWebControls:EditModePanel ID="EditModePanel4" runat="server" CssClass="edit-mode-panel" PageDisplayMode="Display">
	    <aside>
		    <PS:FaqTopics id="FaqTopics" runat="server"/>
		    <PS:FaqSuggestQuestion id="FaqSuggestQuestion" runat="server"/>
	    </aside>	
    </PublishingWebControls:EditModePanel>
	<!-- END Secondary Area -->	
	...
	<div id="top" class="primary narrow">
		...
		<SharePoint:TextField ID="TextField2" runat="server" FieldName="Title"></SharePoint:TextField></span></h1>
            <PublishingWebControls:EditModePanel ID="EditModePanel8" runat="server" CssClass="edit-mode-panel" PageDisplayMode="Display">
			    <ul class="functions">
				    <li><a id="expand" href="#">Expand all &raquo;</a></li>
				    <li><a id="collapse" href="#">Collapse all &raquo;</a></li>
		...
		<article>			
			...
			<PublishingWebControls:EditModePanel ID="EditModePanel3" runat="server" CssClass="edit-mode-panel" PageDisplayMode="Display">
	            <PS:FaqContent id="FaqContent" runat="server"/>
	        </PublishingWebControls:EditModePanel>			
		</article>
	</div>	
